...
RUN curl -L -o RackTables-0.21.1.tar.gz 'http://sourceforge.net/projects/racktables/files/RackTables-0.21.1.tar.gz/download?source=files'
RUN tar -xzf RackTables-0.21.1.tar.gz
